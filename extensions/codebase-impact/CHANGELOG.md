...
- `dk.codebase-impact.analyze` command: scan codebase for integration points, affected features, dependency stability, test impact, and IMPACT-NNN task candidates.
